 ...
 */
final class Version20220821125347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES user_sec (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
